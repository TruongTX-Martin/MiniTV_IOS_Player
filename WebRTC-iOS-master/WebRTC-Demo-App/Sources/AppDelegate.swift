...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func buildMainViewController() -> UIViewController {
        let signalClient = Client.shared.signalClient!
        let webRTCClient = Client.shared.webRTCClient!
...
//        let mainViewController = MainViewController(signalClient: signalClient,webRTCClient: webRTCClient)
        ...
        let vc = MainViewController.instantiate(signalClient: signalClient, webRTCClient: webRTCClient)
